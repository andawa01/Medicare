...
// This function will convert (YYYY-MM-DD) to (DD-MM-YYYY)
...
const AddPage = () => {
    ...
    try {
      ...
      if (data?.token) {
        try {
          ...
          console.error("Could not store token:", err);
        }
      }
  ...
  return (
    <div className={s.pageContainer}>
      ...
      {/* Doctor List (for demonstration, can be removed) */}
