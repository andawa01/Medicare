...
// to get todays date exYYYY-MM-DD
...
//for reschedule button and its edit mode
...
const ServiceAppointmentPage = () => {
  ...
  // sort that is upcoming date comes first and previous date comes later
    ...
    <div className={serviceAppointmentsStyles.container}>
      <header className={serviceAppointmentsStyles.headerContainer}>
        ...
        <div className={serviceAppointmentsStyles.searchContainer}>
          ...
          <div className={serviceAppointmentsStyles.searchIcon}>
            <div>
