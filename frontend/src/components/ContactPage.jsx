...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/+254707542884?text=${encodeURIComponent(text)}`;
  ...
  // show the department specific services
          ...
          <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
            ...
            <div>
              ...
              <textarea
                ...
                value={form.message}
                onChange={handleChange}
                placeholder="Describe your concern brief..."
                rows={4}
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>
              Ngara Street, Nairobi, Kenya
            </p>
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> +254 707 542 884
            </p>
            <p className={contactPageStyles.infoItem}>
