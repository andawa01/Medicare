  ...
  const socialLinks = [
    {
      ...
      name: "Facebook",
      href: "https://www.facebook.com/profile.php?id=100073244302675",
    },
    {
      Icon: Twitter,
      color: footerStyles.twitterColor,
      name: "Twitter",
      href: "https://x.com/EvansAndawa",
    },
    {
      Icon: Instagram,
    ...
    },
    {
      ...
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/evans-andawa-1a73a0279/",
    },
    {
      Icon: Youtube,
      ...
      <div className={footerStyles.mainContent}>
          ...
          <div className={footerStyles.companySection}>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+254 123 4567</span>
              </div>
        ...
        <div className={footerStyles.bottomSection}>
          <div className={footerStyles.copyright}>
            <span>&copy; {currentYear} MediCare. All rights reserved.</span>
          </div>
