...
// to get format time either AM or PM
...
// to get date like day month year
...
// to convert 12 hrs coming from 24h
...
export default function DashboardPage({ apiBase }) {
  ...
  //check whether appt is cancel or complete the we can't reschedule
